                        ...
                        >
                            ...
                            >
                                <div className="relative">
                                    ...
                                    {/* End Date */}
                                    <div className="mt-4">
                                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest block text-center mb-2">
                                            מועד סיום
                                        </label>
                                        <div className="flex items-center gap-2">
                                            <input
                                            ...
                                            />
                                            {editEventEndDate && (
                                                <div className="px-2 py-1 rounded-lg bg-slate-100 border border-slate-200 text-[11px] font-black text-slate-600 whitespace-nowrap">
                                                    {getDayName(new Date(editEventEndDate).getTime())}
                                                </div>
                                            )}
                                        </div>
                                    </div>
